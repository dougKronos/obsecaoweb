...
/**
 * Este comando é do livro.
 *
 * @author Douglas Leandro <douglas.gtads@gmail.com>
 * @since 2.0
 */
class BasicController extends Controller{
	
	/**
     * Este comando imprime 'HelloWorld' e retorna o Código de Erro '0'.
     */
	public function actionIndex(){
		echo "Douglas - HelloWorld\n";
		return 0;
	}
